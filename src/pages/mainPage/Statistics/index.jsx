...
import MainAuth from '../../../components/template/Main';

const Main = ({ children }) => localStorage.getItem('@slrx-Token') ? <MainAuth title="Estatísticas">{children}</MainAuth> : <MainApp>{children}</MainApp>
